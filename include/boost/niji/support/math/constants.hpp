...
//////////////////////////////////////////////////////////////////////////////*/
#ifndef BOOST_NIJI_MATH_CONSTANTS_HPP_INCLUDED
#define BOOST_NIJI_MATH_CONSTANTS_HPP_INCLUDED
...
namespace boost { namespace math { namespace constants { namespace detail
{
    ...
    struct sel : sel_impl<T const, construction_traits<T, Policy>::type::value>
    {};
}}}}

#define BOOST_NIJI_CONSTANT(T, val) ::boost::math::constants::detail::sel<T>::apply(BOOST_JOIN(val, F), val, BOOST_JOIN(val, L), #val)
#define BOOST_NIJI_CONSTANTS_(_, T, i, val) BOOST_PP_COMMA_IF(i) BOOST_NIJI_CONSTANT(T, val)
#define BOOST_NIJI_CONSTANTS(T, seq) BOOST_PP_SEQ_FOR_EACH_I(BOOST_NIJI_CONSTANTS_, T, seq)

namespace boost { namespace niji { namespace constants
{
